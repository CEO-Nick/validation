...
public class ValidationItemControllerV2 {
    ...
    //@PostMapping("/add")            // BindingResult는 무조건 @ModelAttribute 바로 뒤에!! 순서중요!!
    public String addItemV1(@ModelAttribute Item item, BindingResult bindingResult, RedirectAttributes redirectAttributes, Model model) {

        // errors = bindingResult 
        // bindgingResult가 기존 v1의 error를 대체

        // 검증 로직 (사용자 요구사항에 따라 달라질 수 있는 부분)
    ...
    @PostMapping("/add")    //@Validated 하나만 넣어놓으면 item에 대해서 알아서 검증다하고 -> 검증 결과는 bindingResult에 담아놓는다.
